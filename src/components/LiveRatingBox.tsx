...
export default function LiveRatingBox({ currentRatingChange, currentRating }: LiveRatingBoxProps) {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 relative overflow-hidden h-auto md:h-full flex flex-col items-center justify-center p-8 w-full transition-all hover:shadow-2xl hover:border-blue-100 group">
      {/* Decorative background element */}
      <div className="absolute -top-12 -right-12 w-32 h-32 bg-blue-50 rounded-full opacity-50 group-hover:scale-110 transition-transform duration-500" />
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <div className="relative mb-4">
          ...
          {/* Subtle glow effect */}
          <div className="absolute -inset-4 bg-blue-400/5 blur-2xl rounded-full -z-10" />
        </div>
