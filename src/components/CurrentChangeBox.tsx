        ...
        <div className="bg-white rounded-xl shadow-lg current-change-box h-auto md:h-full flex flex-col items-center justify-start md:justify-center md:items-center w-full">
            ...
            <div className="flex flex-col items-center justify-center">
                <span className="text-[8rem] font-bold flex items-center gap-4">
                    {currentRatingChange > 0 && <FaArrowUp className="text-green-600 text-6xl md:text-7xl" />}
                    {currentRatingChange < 0 && <FaArrowDown className="text-red-600 text-6xl md:text-7xl" />}
                    {currentRatingChange === 0 && <FaMinus className="text-gray-400 text-6xl md:text-7xl" />}
