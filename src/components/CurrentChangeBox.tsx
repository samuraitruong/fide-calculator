...
export default function CurrentChangeBox({ currentRatingChange }: CurrentChangeBoxProps) {
    return (
        <div className="bg-white rounded-xl shadow-lg p-8 current-change-box h-auto md:h-full flex flex-col items-center justify-start md:justify-center md:items-center w-full">
            <h2 className="text-lg font-medium text-gray-700 mb-2 text-center">Current Change</h2>
