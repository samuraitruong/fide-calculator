...
import { FaSignInAlt, FaUser, FaSignOutAlt, FaHdd, FaEnvelope } from 'react-icons/fa';
        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-4">
            ...
            <Link
              ...
              className="w-full inline-flex items-center justify-center gap-2 bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-gray-600 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
            >
